(function() {
	...
	model.sendStats = function() {
		...
		if (gameLinkId === undefined) {
			...
			report.reporterTeam = decode(localStorage[paStatsGlobal.pa_stats_session_team_index]);
			report.observedTeams = decode(localStorage[paStatsGlobal.pa_stats_session_teams]);
