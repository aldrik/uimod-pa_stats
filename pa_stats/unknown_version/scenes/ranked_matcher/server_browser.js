var pasDevMode = typeof statsDevelopmentNeverUseThisNameAnywhereElseIDareYou != 'undefined';
...
$('#sidebar').append('<a href="#" class="btn_std" style="width: 100%" data-bind="click: startRankedGame, click_sound: \'default\', rollover_sound: \'default\' ">'+
		'<div class="btn_label">'+
		(pasDevMode ? 'dev mode 1v1' : 'Automatches are disabled in PTE builds!')+
		'</div>'+
...
(function() {
	...
	model.preferredCommander = ko.observable().extend({ local: 'preferredCommander_v2' });
